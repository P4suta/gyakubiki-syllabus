...
// Desktop grid (day count is data-driven, so these track `days`)
const gridCols = $derived(`56px repeat(${days.length}, 1fr)`)
const minWidth = $derived(`${days.length * 120 + 56}px`)
</script>
